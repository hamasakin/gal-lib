...
last_updated: "2026-05-24T09:58:00.000Z"
last_activity: "2026-05-24 — Quick 260524-olt：接入 i18next + react-i18next，三套 translation.json 各 461 条 key 对齐，设置页加「界面语言」下拉切换 + localStorage 持久化；Sidebar / Settings / Library / Scan / Stats / Detail / Screenshots / Persons + 12 个组件 / 全局 toast helper 全部走 t()；专有名词 (galgame/Bangumi/VNDB/Locale Emulator/LE/Tauri/Hakoniwa) 保留原文；npm run build 通过；GUI 切换真机验证待人工确认。"
progress:
  total_phases: 4
  completed_phases: 4
  total_plans: 16
