...
- [ ] **Phase 1: Foundation** - Tauri 应用骨架、Portable 数据层、SQLite migrations、双栏 App Shell
- [ ] **Phase 2: Library Ingest** - 多目录扫描、exe 识别、Bangumi/VNDB 元数据抓取、封面网格渲染
...
| 2. Library Ingest | 0/TBD | Not started | - |
| 3. Launch & Playtime | 0/TBD | Not started | - |
